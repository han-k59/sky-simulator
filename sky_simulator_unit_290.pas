...
procedure find_areas(ra1,dec1,fov :double; out area1,area2,area3,area4 :integer; out frac1,frac2,frac3,frac4:double);{find up to four star database areas for the square image. Maximum size is a little lesse the one database field 9.5x9.5 degrees}
function readdatabase290(telescope_ra,telescope_dec, field_diameter:double; area290: integer; out ra2,dec2, mag2,Bp_Rp : double): boolean;{star 290 file database search}
...
begin
  ...
  if fileexists( application_path+'g14_0101.290') then name_star:='g14' {database required}
  else
