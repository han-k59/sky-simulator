...
uses sky_simulator_main, {for floattostrFdot}
...
begin
  result:=4; // rotatore version implementation
end;
...
function  T_Alpaca_rotator.DeviceState:TStringList;
begin
  result:=TStringList.Create;
  result.Clear;
  result.add('{"Name":"MechanicalPosition","Value":'+floattostrFdot(MechanicalPosition,0,2)+'}');
  result.add('{"Name":"Position","Value":'+floattostrFdot(Position,0,2)+'}');
  result.add('{"Name":"IsMoving","Value":'+BoolToStr(IsMoving,'true','false')+'}');
  result.add('{"Name":"TimeStamp","Value":"'+utc_date_time+'"}'); //string between  " "}
end;
