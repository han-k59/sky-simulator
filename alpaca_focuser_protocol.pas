...
begin
  result:=4; // Version implementation
end;
...
function  T_Alpaca_focuser.DeviceState:TStringList;
begin
  result:=TStringList.Create;
  result.Clear;
  // IsMoving, Position,  Temperature,  TimeStamp
  result.add('{"Name":"IsMoving","Value":'+BoolToStr(IsMoving,'true','false')+'}');
  result.add('{"Name":"Position","Value":'+inttostr(Position)+'}');
  result.add('{"Name":"Temperature","Value":'+floattostrFdot(Temperature,0,1)+'}');
